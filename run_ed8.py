...
dT_x_ed = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
dT_y_ed = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
dT_z_ed = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))

d2T_x_ed = ti.field(float, shape=(res_x, res_y, res_z))
d2T_y_ed = ti.field(float, shape=(res_x, res_y, res_z))
d2T_z_ed = ti.field(float, shape=(res_x, res_y, res_z))

psi_000 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_001 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_010 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_011 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_100 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_101 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_110 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))
psi_111 = ti.Vector.field(3, float, shape=(res_x, res_y, res_z))

memory_usage = sum_memory_usage([
    T_x, T_y, T_z, psi_x, psi_y, psi_z,
    psi_ed, T_x_ed, T_y_ed, T_z_ed,
    dT_x_ed, dT_y_ed, dT_z_ed, d2T_x_ed, d2T_y_ed, d2T_z_ed,
    psi_000, psi_001, psi_010, psi_011, psi_100, psi_101, psi_110, psi_111
])
...
@ti.kernel
def split_psi_hermite():
    for I in ti.grouped(T_x):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_ed, 0, T_x_ed, dT_x_ed, d2T_x_ed, X_x[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_ed, 1, T_y_ed, dT_y_ed, d2T_y_ed, X_x[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_ed, 2, T_z_ed, dT_z_ed, d2T_z_ed, X_x[I], dx)
        T_x_0, T_y_0, T_z_0 = transpose_matrix(T_x_0, T_y_0, T_z_0)
        psi_x[I] = ti.Vector([psi_x_0, psi_y_0, psi_z_0])
        T_x[I] = T_x_0

    for I in ti.grouped(T_y):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_ed, 0, T_x_ed, dT_x_ed, d2T_x_ed, X_y[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_ed, 1, T_y_ed, dT_y_ed, d2T_y_ed, X_y[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_ed, 2, T_z_ed, dT_z_ed, d2T_z_ed, X_y[I], dx)
        T_x_0, T_y_0, T_z_0 = transpose_matrix(T_x_0, T_y_0, T_z_0)
        psi_y[I] = ti.Vector([psi_x_0, psi_y_0, psi_z_0])
        T_y[I] = T_y_0

    for I in ti.grouped(T_z):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_ed, 0, T_x_ed, dT_x_ed, d2T_x_ed, X_z[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_ed, 1, T_y_ed, dT_y_ed, d2T_y_ed, X_z[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_ed, 2, T_z_ed, dT_z_ed, d2T_z_ed, X_z[I], dx)
        T_x_0, T_y_0, T_z_0 = transpose_matrix(T_x_0, T_y_0, T_z_0)
        psi_z[I] = ti.Vector([psi_x_0, psi_y_0, psi_z_0])
        T_z[I] = T_z_0


def march_psi_grid(dt):
    advect_ps_hermite_ed8(psi_000, psi_001, psi_010, psi_011, psi_100, psi_101, psi_110, psi_111,
                          psi_ed, T_x_ed, T_y_ed, T_z_ed, dT_x_ed, dT_y_ed, dT_z_ed,
                          d2T_x_ed, d2T_y_ed, d2T_z_ed, u_x, u_y, u_z, X, dx, dt, ed_eps)
    split_psi_hermite()
    ...
    while True:
        ...
        if j == 0:
            reset_to_identity(phi_x, phi_y, phi_z, F_x,
                              F_y, F_z)
            reset_to_identity_3(psi_ed, T_x_ed, T_y_ed, T_z_ed, dT_x_ed,
                                dT_y_ed, dT_z_ed, d2T_x_ed, d2T_y_ed, d2T_z_ed, X)
