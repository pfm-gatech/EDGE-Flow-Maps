...
d2T_x_garm = ti.field(float, shape=(res_x, res_y, res_z))
d2T_y_garm = ti.field(float, shape=(res_x, res_y, res_z))
d2T_z_garm = ti.field(float, shape=(res_x, res_y, res_z))
...
memory_usage = sum_memory_usage([
    ...
    d2T_x_garm, d2T_y_garm, d2T_z_garm
])
...
def split_psi_hermite():
    for I in ti.grouped(T_x):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_garm, 0, T_x_garm, dT_x_garm, d2T_x_garm, X_x[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_garm, 1, T_y_garm, dT_y_garm, d2T_y_garm, X_x[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_garm, 2, T_z_garm, dT_z_garm, d2T_z_garm, X_x[I], dx)
    ...
    for I in ti.grouped(T_y):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_garm, 0, T_x_garm, dT_x_garm, d2T_x_garm, X_y[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_garm, 1, T_y_garm, dT_y_garm, d2T_y_garm, X_y[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_garm, 2, T_z_garm, dT_z_garm, d2T_z_garm, X_y[I], dx)
        T_x_0, T_y_0, T_z_0 = transpose_matrix(T_x_0, T_y_0, T_z_0)
    ...
    for I in ti.grouped(T_z):
        psi_x_0, T_x_0 = interp_grad_hermite(
            psi_garm, 0, T_x_garm, dT_x_garm, d2T_x_garm, X_z[I], dx)
        psi_y_0, T_y_0 = interp_grad_hermite(
            psi_garm, 1, T_y_garm, dT_y_garm, d2T_y_garm, X_z[I], dx)
        psi_z_0, T_z_0 = interp_grad_hermite(
            psi_garm, 2, T_z_garm, dT_z_garm, d2T_z_garm, X_z[I], dx)
        T_x_0, T_y_0, T_z_0 = transpose_matrix(T_x_0, T_y_0, T_z_0)
...
def march_psi_grid(dt):
    advect_ps_garm(psi_tmp,
                   T_x_tmp, T_y_tmp, T_z_tmp,
                   psi_garm,
                   T_x_garm, T_y_garm, T_z_garm,
                   dT_x_garm, dT_y_garm, dT_z_garm,
                   d2T_x_garm, d2T_y_garm, d2T_z_garm,
                   u_x, u_y, u_z,
                   X, dx, dt)
    ...
    while True:
        ...
        if j == 0:
            reset_to_identity(phi_x, phi_y, phi_z, F_x,
                              F_y, F_z)
            reset_to_identity_3(psi_garm, T_x_garm, T_y_garm, T_z_garm, dT_x_garm,
                                dT_y_garm, dT_z_garm, d2T_x_garm, d2T_y_garm, d2T_z_garm, X)
